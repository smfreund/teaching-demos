...
We also changed the theme! ggplot has [8 built-in themes](http://r4ds.had.co.nz/images/visualization-themes.png) to choose from. There are also lots of other themes built into extension packages such as gg_themes, gg_sci, and ggthemr. Here are a couple of examples.
(PUT COOL EXAMPLES HERE)
