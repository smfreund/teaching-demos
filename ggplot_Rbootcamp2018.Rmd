...
* **scales**, which allow you to adjust how to represent the data on axes and colors
...
* NEXT TALK ABOUT COLOR STUFF: R COLOR BREWER SCALES, CREATING YOUR OWN SCALES
* If time, add stuff for ggplot stats -- error bars, trendlines, overlaying density distributions on histograms, etc. Also LABELS! (see ggrepel)

### ggplot extensions

ggmap, ggridges, http://www.ggplot2-exts.org/gallery/ 
